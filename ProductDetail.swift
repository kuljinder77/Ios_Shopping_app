...
class ProductDetail: UIViewController {
    ...
    */
    @IBAction func addToCart(_ sender: Any) {
        ...
        // 3
        productData.setValue(name.text!, forKeyPath: "name")
        productData.setValue(type.text!, forKeyPath: "type")
        productData.setValue(company.text!, forKeyPath: "company")
        productData.setValue(Double(price.text!), forKeyPath: "price")
        productData.setValue(desc.text!, forKeyPath: "disc")
